...
\smallskip
\warningbox{\textbf{DO NOT} attempt to over-clock or otherwise alter the clock frequency your TAU computing unit by tampering with the clock generator. Damaging the warranty breakaway sticker on your TAU computing unit will immediately VOID YOUR WARRANTY. \companyname{} is not held responsible for any accidents occurring during use of an improperly over-clocked machine.}
